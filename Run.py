...
# Load the trained model (change the extension to .keras)
model_path = 'models/best_model.keras'  # Path to your trained model (.keras format)
...
output_csv_path = 'logs/seed_predictions.csv'  # Output CSV file for predictions
