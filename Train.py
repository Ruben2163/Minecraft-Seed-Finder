...
checkpoint = ModelCheckpoint(
    'models/best_model.keras',  # Change to .keras extension
    monitor='val_loss',
    save_best_only=True,
    mode='min',
    verbose=1
...
# Save the final model (optional, in case you want to keep a backup of the last trained model)
model.save('models/Minecraft-Seed-Finder_2_final.h5')
